...
export const homeDestinationRanks = [
  { country: '德国', value: '12.6 TB', note: '整车研发' },
  { country: '新加坡', value: '8.2 TB', note: '道路测试' },
  { country: '日本', value: '7.4 TB', note: '制造与升级' },
  { country: '美国', value: '5.1 TB', note: '智能驾驶' },
  { country: '阿联酋', value: '4.3 TB', note: '车联网运营' },
];
